...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset ('font-awesome-6.7.2/css/sharp-duotone-thin.css')}}">
      <!-- overlayScrollbars -->
  {{-- <link rel="stylesheet" href="{{asset('AdminLTE-3.2/plugins/overlayScrollbars/css/OverlayScrollbars.min.css')}}"> --}}
    <!-- IonIcons -->
    <link
      rel="stylesheet"
      ...
      <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-sm-inline-block">
            <a href="{{asset('AdminLTE-3.2/index3.html')}}" class="nav-link">Home</a>
          </li>
          <li class="nav-item d-none d-sm-inline-block">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
              ...
              <a href="#" class="dropdown-item">
                ...
                <div class="media">
                  <img
                    src="{{asset('AdminLTE-3.2/dist/img/user8-128x128.jpg')}}"
                    alt="User Avatar"
